...
<!--ts-->
 * [Context](https://github.com/mesterhammerfic/x_ray_classification#context)
 * [Data](https://github.com/mesterhammerfic/x_ray_classification#data)
 * [Results](https://github.com/mesterhammerfic/x_ray_classification#results)
 * [Next Steps](https://github.com/mesterhammerfic/x_ray_classification#next-steps)
 * [Contribute](https://github.com/mesterhammerfic/x_ray_classification#contribute)
<!--te-->

## Context
Hospital wait times can be extrememly long, especially in areas with few hospitals or small radiology departments. In some cases, wait times can even [negatively impact] patient health. If a hospital could increase the efficiency of its radiology department, it could provide treatment more quickly and significanly improve patient experience.
...
### Business recommendations
 - Train this neural net on a larger more varied data set.
 - Use CNN's prioritize patients for quicker review, diagnoses, and treatment.
...
1. Install conda environment (details below)
2. Download data
       * To reproduce our results, download our altered data set [here](https://www.dropbox.com/s/r23oastdde1v215/chest_xray.zip?dl=0) (see notes on cleaning above for details)
       * To get the original detaset, download it [here](https://www.kaggle.com/paultimothymooney/chest-xray-pneumonia):
The data we are using can be found  and should be unzipped into the [data](/data) folder in this projects main directory.
3. Model iterations are stored in the notebooks/exploratory folder and modules are stored in the src folder
