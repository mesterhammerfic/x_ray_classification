...
def load_data_generators():
    ...
    train_gen = train_data_generator.flow_from_directory('../../data/chest_xray/train/',
                                                   target_size=(100,100),
                                                   batch_size=32,
                                                   class_mode='binary',
                                                   color_mode='grayscale')
    val_gen = val_data_generator.flow_from_directory('../../data/chest_xray/val/',
                                                   target_size=(100,100),
                                                   batch_size=32,
                                                   class_mode='binary',
                                                   color_mode='grayscale')
    test_gen = test_data_generator.flow_from_directory('../../data/chest_xray/test//',
                                                 target_size=(100,100),
                                                 batch_size=32,
                                                 class_mode='binary',
                                                 color_mode='grayscale')
